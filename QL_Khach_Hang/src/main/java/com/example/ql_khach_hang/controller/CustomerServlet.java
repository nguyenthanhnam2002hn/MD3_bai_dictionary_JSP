package com.example.ql_khach_hang.controller;

import com.example.ql_khach_hang.model.Customer;
import com.example.ql_khach_hang.service.CustomerService;
import com.example.ql_khach_hang.service.impl.CustomerServiceImpl;
...
public class CustomerServlet extends HttpServlet {
    ...
    private void createCustomer(HttpServletRequest request, HttpServletResponse response) {
        String name = request.getParameter("name");
        String email = request.getParameter("email");
        String address = request.getParameter("add  ress");
